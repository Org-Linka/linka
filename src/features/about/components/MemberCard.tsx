  ...
  return (
    <Animated.View style={{ transform: [{ scale }] }}>
      <TouchableOpacity
        ...
        className="flex-row items-center rounded-[20px] border border-[#2f3b69]/10 bg-white dark:bg-zinc-800 px-4 py-4"
      ...
      >
        ...
        <View className="flex-1">
          <AccessibleText className="text-[17px] font-atkinson-bold text-[#2f3b69] dark:text-blue-100">{member.nome}</AccessibleText>
          <AccessibleText className="mt-[2px] text-[13px] text-zinc-400 font-atkinson">{member.descricao}</AccessibleText>
        </View>
