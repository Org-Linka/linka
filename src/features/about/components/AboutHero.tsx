      ...
      <View className="w-full max-w-[420px] self-center">
        <View className="flex-row items-center justify-between">
          <TouchableOpacity
            activeOpacity={0.7}
            onPress={() => router.back()}
            className="h-10 w-10 items-center justify-center rounded-full bg-white/10 dark:bg-zinc-900/10"
          >
          ...
          <View className="flex-row items-center gap-2">
            ...
            <AccessibleText className="text-3xl font-atkinson-bold text-white">Linka</AccessibleText>
          </View>
        </View>

        <View className="mt-7 items-center">
          <AccessibleText className="text-center text-4xl font-atkinson-bold text-white">Sobre nós</AccessibleText>
